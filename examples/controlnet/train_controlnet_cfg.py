...
def make_train_dataset(args, tokenizer, accelerator):
    ...
    def maskout_sketches(sketches):
        for idx in range(len(sketches)):
            if random.random() < args.proportion_empty_sketches:
                sketches[idx] = torch.zeros_like(sketches[idx])
        return sketches
    ...
    def preprocess_train(examples):
        ...
        examples["conditioning_sketch_pixel_values"] = maskout_sketches(conditioning_sketches)
